...
void fitOptics()
{
  ...
  Double_t eP0[4] = {8.543210, 8.547187, 8.547187, 8.547187};  //central spec. momentum (FIRST OPTIMIZATION, using "00000" term as ppcentral_offset)  
 ...
 //Define TTree variables names
  ...
  Double_t Em_cut_arr[4] = {0.06, 0.03, 0.04, 0.045};      //Em cuts after FIRST SHMS DELTA OPTIMIZATION
