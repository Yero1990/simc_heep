...
void calc_hProt_PDiff()
{
  ...
  Double_t Pc[4] = {2.929192,  3.48*0.996524, 2.31*0.997783, 1.8899*0.998217};  //Corrected HMS Momentum
 ...
 //Define some variables to be determined inside the entry loop
  ...
  double Em_min[4] = {0.06, 0.04, 0.04, 0.04};
  ...
  ofile << "#3248: "<< 1. - (yRes_diff[0]/Pc[0]) << "   +/-  " <<  yRes_diff_err[0]/Pc[0] << "    " <<  endl;
