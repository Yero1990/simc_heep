...
Double_t Em_xmin = -0.15;
Double_t Em_xmax = 0.15;

//Pmiss
Double_t Pm_nbins = nbins;
Double_t Pm_xmin = -0.02;
Double_t Pm_xmax = 0.1;
...
Double_t xbj_xmin = 0.9;
Double_t xbj_xmax = 1.05;
...
Double_t hytar_xmin = -3.;
Double_t hytar_xmax = 3.;

Double_t hxptar_nbins = nbins;
Double_t hxptar_xmin = -0.06;
Double_t hxptar_xmax = 0.06;

Double_t hyptar_nbins = nbins;
Double_t hyptar_xmin = -0.03;
Double_t hyptar_xmax = 0.03;

Double_t hdelta_nbins = nbins;
Double_t hdelta_xmin = -5.;
Double_t hdelta_xmax = 5.;
...
Double_t eyptar_xmin = -0.05;
Double_t eyptar_xmax = 0.05;
...
Double_t Q2_xmin = 6;
Double_t Q2_xmax = 7.2;

Double_t om_xmin = 3.3;
Double_t om_xmax = 3.8;

Double_t the_xmin = 30.;
Double_t the_xmax = 38.;

Double_t thp_xmin = 19.;
Double_t thp_xmax = 24.;

Double_t kf_xmin = 2.6;
Double_t kf_xmax = 3.1;

Double_t Pf_xmin = 3.8;
Double_t Pf_xmax = 4.9;

Double_t Ep_xmin = 3.8;
Double_t Ep_xmax = 6;

Double_t thq_xmin = 9.;
Double_t thq_xmax = 14.;
