...
void calc_pElec_PDiff()
{
  ...
  Double_t eP0[4] = {8.520526, 8.520526, 8.526644, 8.528391};   //starting central spec momentum 
  //Double_t eP0[4] = {8.526797, 8.536896, 8.531231, 8.533457};   //corrected central momentum

  Double_t hP0[4] = {2.931169, 3.470903, 2.306895, 1.888348};  //starting central spec. momentum 
  //  Double_t hP0[4] = {2.9376278, 3.4789385, 2.3118938, 1.8923683};    //corrected HMS central spec momentum  
 ...
 //Define some variables to be determined inside the entry loop
  ...
  //Loop over runs
	...
	if(emiss < 0.04 &&  data_hmsDelta_cut && data_shmsDelta_cut &&  data_hmsPdiff_cut)
	  {
