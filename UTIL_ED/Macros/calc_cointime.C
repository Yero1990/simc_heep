...
void calc_cointime(Int_t runNumber,  TString shms_particle, Int_t analyzedEvents)
{
  TString fileName; // = ROOT_FILE_PATH;
    ...
    TH1D *h1PcointimeROC1 = new TH1D("SHMS ROC1 Corrected Coin Time","SHMS ROC1 Corrected Coin Time; cointime [ns]", 400, -20, 40);
    TH1D *h1PcointimeROC2 = new TH1D("SHMS ROC2 Corrected Coin Time","SHMS ROC2 Corrected Coin Time; cointime [ns]", 400, -20, 40);
	...
	cerCut= "P.ngcer.npeSum > 0.1 && H.cer.npeSum < 0.1";
	...
	if(shms_particle == "e")
	{
	    if( !(PgtrBetaMes > 0.5 && PgtrBetaMes < 1.5                       // e- beta cut
		  ...
		  && PngcerNpeSum > 0.1 && HcerNpeSum < 0.1                    // Cerenkov counter cut for e- and proton
	...
	else
	{
	    if( !(PgtrBetaMes > 0.5 && PgtrBetaMes < 1.5                       // proton beta cut
		  ...
		  && HcerNpeSum > 0.1 && PngcerNpeSum < 0.1                    // Cerenkov counter cut for e- and proton
