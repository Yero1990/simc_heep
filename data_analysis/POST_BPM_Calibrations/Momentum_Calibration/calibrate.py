...
#print ('HMS P Corr_Factor (80 MeV)  = ',  fit.line(0.778546))
#print ('HMS P Corr_Factor (580 MeV) = ',  fit.line(0.600654))
#print ('HMS P Corr_Factor (750 MeV) = ',  fit.line(0.57246))
print ('HMS P Corr_Factor (oPTICS)  = ',  fit.line(2.7659))
